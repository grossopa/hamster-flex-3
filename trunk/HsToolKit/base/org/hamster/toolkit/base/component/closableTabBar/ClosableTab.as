package org.hamster.toolkit.base.component.closableTabBar
{
	...
	{
		protected var closeButtonFactory:IFactory = new ClassFactory(CloseButton);
...
//		}
		...
		{
			if (event.target == _closeButton) {
				var disEvt:ClosableTabBarEvent = new ClosableTabBarEvent(ClosableTabBarEvent.CLOSE_TAB, true);
