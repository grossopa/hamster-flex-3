package org.iotashan.oauth
{
	...
	{
		private static var _instance:OAuthSignatureMethod_HMAC_SHA1;
		
		public static function getInstance():OAuthSignatureMethod_HMAC_SHA1
		{
			if (_instance == null) {
				_instance = new OAuthSignatureMethod_HMAC_SHA1();
			}
			return _instance;
		}
