...
public function appCompleteHandler():void
{
	...
	config.setRequestToken('4mv684i21q7by0x', 'fxexwf0qcd5k62y');
	config.setAccessToken('agemy9gvjwyesz1', 'iifyfz08ahh0d3a');
...
{
	dropAPI.metadata(testFolder1 + '/copied_' + testFile, 1000, "", true);
	var handler:Function = function (evt:DropboxEvent):void
	{
